namespace XmsExam.Migrations.ApplicationUsersMigrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<XmsExam.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(XmsExam.Models.ApplicationDbContext context)
        {
            var manager =
